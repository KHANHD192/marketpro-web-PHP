...
<?php
    if(isset($_POST['btn-placeOrder'])){
      ...
      //create order
        ...
        $sql = "INSERT INTO orders(CustomerID,OrderDate,Status) VALUES('$customerID','$datetime','$status')";
        $result = $conn->query($sql);
        if($result){
          //create order detaild 
          $last_id = $conn->insert_id;
            $len = count( $_SESSION['cart']);
            for($i = 0 ; $i < $len ; $i++){
                $productID= $_SESSION['cart'][$i]['productID'];
                $quantity = $_SESSION['cart'][$i]['Quantity'];
                $unitPrice = $_SESSION['cart'][$i]['Price'];
                $sql = "INSERT INTO orderdetails(OrderID, ProductID,Quantity,UnitPrice) VALUES('$last_id','$productID','$quantity','$unitPrice')";
                $result_ordersDetail = $conn->query($sql);
            }
        }
        $_SESSION['cart'] = [];
                ...
                <form action="#" class="pe-xl-5">
                    <div class="row gy-3">
                        <div class="col-sm-6 col-xs-6">
                            <input type="text" name="Frist_Name" class="common-input border-gray-100" placeholder="First Name">
                        </div>
                        <div class="col-sm-6 col-xs-6">
                            <input name="Last_Name" type="text" class="common-input border-gray-100" placeholder="Last Name">
                        </div>
                        <div class="col-12">
                            <input name="Address" type="text" class="common-input border-gray-100" placeholder="House number and street name">
                        </div>
                        <div class="col-12">
                            <input name="Phone_Number" type="number" class="common-input border-gray-100" placeholder="Phone">
                        </div>                        
                        <div class="col-12">
                            <div class="my-40">
                                <h6 class="text-lg mb-24">Additional Information</h6>
                                <input type="text" class="common-input border-gray-100" placeholder="Notes about your order, e.g. special notes for delivery.">
                            </div>
                        </div>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="checkout-sidebar">
                    ...
                    <div class="border border-gray-100 rounded-8 px-24 py-40 mt-24">
                        ...
                        <?php 
                        $len_of_product = count($_SESSION['cart']);
                        for($i = 0 ; $i < $len_of_product ; $i++){
                            ...
                            <div class="flex-align gap-12">
                                <span class="text-gray-900 fw-normal text-md font-heading-two w-144">$productName</span>
                            ...
                            <span class="text-gray-900 fw-bold text-md font-heading-two">$$price</span>
                        </div>
                    EOT;
                        }
                        ?>
                   ...
                   <?php
                        ...
                        echo <<<EOT
                            ...
                            <div class="mb-32 flex-between gap-8">
                                ...
                                <span class="text-gray-900 font-heading-two text-md fw-bold">$$subtotal</span>
                            </div>
                ...
                EOT;    
                   ?>
                    ...
                    <button  type="submit" name="btn-placeOrder" value="Enable" class="btn btn-main mt-40 py-18 w-100 rounded-8 mt-56">Place Order</a>
